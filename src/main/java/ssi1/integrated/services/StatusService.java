...
import ssi1.integrated.exception.MethodNotAllowedException;
...
public class StatusService {
    ...
    public Status updateStatus(Integer statusId, Status newStatus) {
        if (statusId.equals(1)) {
            throw new MethodNotAllowedException("Status id 1 can't be update!");
        }
    ...
    public Status deleteStatus(Integer statusId){
        if (statusId.equals(1)) {
            throw new MethodNotAllowedException("Status id 1 can't be delete!");
        }
